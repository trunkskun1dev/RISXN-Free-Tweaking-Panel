@echo off
cls
title RISXN FREE V20 - DISCORD.GG/RISXN
...
echo.
echo.
echo                          [D] Discord   [X] Better Tweaks   [Y] YouTube
echo.
echo.
echo.
echo.
...
:msi
powershell -Command "& {Add-Type -AssemblyName System.Windows.Forms; [System.Windows.Forms.MessageBox]::Show('Check MSI Mode for your GPU and set High Priority and then hit apply in top right corner.', 'Risxn Free Tweaking Panel', 'OK', [System.Windows.Forms.MessageBoxIcon]::Information);}"
...
:dqsize
start C:\risxnfree\resources\DQ_Guide.txt
cls
echo.
echo.
echo.
